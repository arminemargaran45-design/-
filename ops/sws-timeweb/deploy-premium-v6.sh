...
WORK="/tmp/sws-premium-v6-$STAMP"
SITE="$WORK/sws-site"
RELEASE="/opt/styling-wrap-studio/releases/$STAMP-premium-v6"
...
grep -q 'PREMIUM V6' "$SITE/styles.css" || fail "Premium V6 CSS missing"
grep -q 'map-frame iframe{filter:none!important}' "$SITE/styles.css" || fail "color map fix missing"
grep -q 'height:155svh!important' "$SITE/styles.css" || fail "mobile story fix missing"
...
[ -s "$SITE/assets/sws/steering-wheel.webp" ] || fail "atelier photo missing"
...
ROUTES=("/" "/services/" "/services/ppf/" "/services/wrapping/" "/services/blackout/" "/services/detailing/" "/services/coating/" "/services/atelier/" "/services/styling/" "/projects/" "/about/" "/guarantee/" "/contacts/" "/styles.css" "/script.js" "/assets/sws/steering-wheel.webp" "/assets/sws/mercedes-front.jpg")
...
printf '%s' "$CSS" | grep -q 'PREMIUM V6' || fail "V6 not served"
printf '%s' "$CSS" | grep -q 'filter:none!important' || fail "color map not served"
printf '\n====================================================\n'
printf ' SWS PREMIUM V6 ACTIVE\n'
printf ' Premium graphite/champagne palette: ACTIVE\n'
printf ' Mobile scroll scene: FIXED\n'
printf ' Empty mobile gaps: FIXED\n'
printf ' Atelier/local project photos: ACTIVE\n'
