...
WORK="/tmp/sws-desktop-v9-$STAMP"
SITE="$WORK/sws-site"
RELEASE="/opt/styling-wrap-studio/releases/$STAMP-desktop-v9"
...
grep -q 'DESKTOP V9' "$SITE/styles.css" || fail "desktop V9 CSS missing"
...
printf '%s' "$CSS" | grep -q 'DESKTOP V9' || fail "desktop V9 not served"
